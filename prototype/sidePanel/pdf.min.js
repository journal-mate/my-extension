    ...
    (() => {
        ...
        var __webpack_modules__ = [
                ...
                (t, e, s) => {
                    ...
                    e.arraysToBytes = function arraysToBytes(t) {
                        ...
                        for (let s = 0; s < e; s++) {
                            ...
                            e instanceof Uint8Array ||
                                (e = 'string' == typeof e ? stringToBytes(e) : new Uint8Array(e));
                    ...
                    e.createValidAbsoluteUrl = function createValidAbsoluteUrl(t, e = null, s = null) {
                        if (!t) return null;
                        try {
                    ...
                    e.isArrayEqual = function isArrayEqual(t, e) {
                        ...
                        for (let s = 0, n = t.length; s < n; s++) if (t[s] !== e[s]) return !1;
                        return !0;
                    };
                    ...
                    let i = n.WARNINGS;
                    function warn(t) {
                        i >= n.WARNINGS && console.log(`Warning: ${t}`);
                    }
                    function unreachable(t) {
                        throw new Error(t);
                    }
                    function shadow(t, e, s) {
                        Object.defineProperty(t, e, { value: s, enumerable: !0, configurable: !0, writable: !1 });
                        return s;
                    }
                    const r = (function BaseExceptionClosure() {
                    ...
                    e.BaseException = r;
                    e.PasswordException = class PasswordException extends r {
                        constructor(t, e) {
                            super(t, 'PasswordException');
                            this.code = e;
                        }
                    };
                    e.UnknownErrorException = class UnknownErrorException extends r {
                        constructor(t, e) {
                            super(t, 'UnknownErrorException');
                            this.details = e;
                        }
                    };
                    e.InvalidPDFException = class InvalidPDFException extends r {
                        constructor(t) {
                            super(t, 'InvalidPDFException');
                        }
                    };
                    e.MissingPDFException = class MissingPDFException extends r {
                        constructor(t) {
                            super(t, 'MissingPDFException');
                        }
                    };
                    e.UnexpectedResponseException = class UnexpectedResponseException extends r {
                        constructor(t, e) {
                            super(t, 'UnexpectedResponseException');
                            this.status = e;
                        }
                    };
                    e.FormatError = class FormatError extends r {
                        constructor(t) {
                            super(t, 'FormatError');
                        }
                    };
                    e.AbortException = class AbortException extends r {
                        constructor(t) {
                    ...
                    const a = [...Array(256).keys()].map((t) => t.toString(16).padStart(2, '0'));
                    class Util {
                        ...
                        static getAxialAlignedBoundingBox(t, e) {
                            ...
                            return [
                                Math.min(s[0], n[0], i[0], r[0]),
                                Math.min(s[1], n[1], i[1], r[1]),
                                Math.max(s[0], n[0], i[0], r[0]),
                                Math.max(s[1], n[1], i[1], r[1]),
                            ];
                        }
                        ...
                        static intersect(t, e) {
                            ...
                            return i > r ? null : [s, i, n, r];
                        }
                        static bezierBoundingBox(t, e, s, n, i, r, a, o) {
                            const l = [],
                                c = [[], []];
                            let h, d, u, p, g, f, m, b;
                            for (let c = 0; c < 2; ++c) {
                            ...
                            for (; _--; ) {
                                p = l[_];
                                A = 1 - p;
                                c[0][_] = A * A * A * t + 3 * A * A * p * s + 3 * A * p * p * i + p * p * p * a;
                                c[1][_] = A * A * A * e + 3 * A * A * p * n + 3 * A * p * p * r + p * p * p * o;
                            }
                            c[0][y] = t;
                            c[1][y] = e;
                            c[0][y + 1] = a;
                ...
                (__unused_webpack_module, exports, __w_pdfjs_require__) => {
                    ...
                    function getDocument(t) {
                            ...
                            switch (t) {
                                ...
                                case 'data':
                                    if (_is_node.isNodeJS && 'undefined' != typeof Buffer && e instanceof Buffer)
                                        ...
                                        if ('string' == typeof e) n[t] = (0, _util.stringToBytes)(e);
                        ...
                        ('string' != typeof n.docBaseUrl || (0, _display_utils.isDataScheme)(n.docBaseUrl)) &&
                            (n.docBaseUrl = null);
                        ...
                        if (!r) {
                            const t = { verbosity: n.verbosity, port: _worker_options.GlobalWorkerOptions.workerPort };
                        ...
                        r.promise
                            .then(function () {
                                ...
                                const t = _fetchDocument(r, n, i, a),
                                ...
                                return Promise.all([t, s]).then(function ([t, s]) {
                                    if (e.destroyed) throw new Error('Loading aborted');
                                    const i = new _message_handler.MessageHandler(a, t, r.port),
                    ...
                    class PDFPageProxy {
                        ...
                        render({
                            ...
                            const u = this._transport.getRenderingIntent(s, n, d);
                            this.pendingCleanup = !1;
                            ...
                            const g = a || new DefaultCanvasFactory({ ownerDocument: this._ownerDocument }),
                                f = !!(u.renderingIntent & _util.RenderingIntentFlag.PRINT);
                            ...
                            const complete = (t) => {
                                    ...
                                    (this.cleanupAfterRender || f) && (this.pendingCleanup = !0);
                                    this._tryCleanup();
                                    if (t) {
                            ...
                            Promise.all([p.displayReadyCapability.promise, l])
                                .then(([t, e]) => {
                                    if (this.pendingCleanup) complete();
                                        ...
                                        m.initializeGraphics({ transparency: t, optionalContentConfig: e });
                        ...
                        streamTextContent({ disableCombineTextItems: t = !1, includeMarkedContent: e = !1 } = {}) {
                        ...
                        _pumpOperatorList({ renderingIntent: t, cacheKey: e, annotationStorageMap: s }) {
                    ...
                    class LoopbackPort {
                        ...
                        postMessage(t, e) {
                            ...
                            this._deferred.then(() => {
                                for (const t of this._listeners) t.call(this, s);
                            });
                        }
                    ...
                    class PDFWorker {
                        ...
                        _setupFakeWorker() {
                            ...
                            PDFWorker._setupFakeWorkerGlobal
                                .then((t) => {
                                    ...
                                    t.setup(n, e);
                                    const i = new _message_handler.MessageHandler(s, s + '_worker', e);
                        ...
                        static fromPort(t) {
                            ...
                            return this.#e.has(t.port) ? this.#e.get(t.port) : new PDFWorker(t);
                        }
                    ...
                    class WorkerTransport {
                        ...
                        getRenderingIntent(t, e = _util.AnnotationMode.ENABLE, s = null, n = !1) {
                            ...
                            return {
                                renderingIntent: i,
                                cacheKey: `${i}_${_annotation_storage.AnnotationStorage.getHash(r)}`,
                        ...
                        destroy() {
                            ...
                            const t = [];
                            for (const e of this.#n.values()) t.push(e._destroy());
                            this.#n.clear();
                            this.#i.clear();
                        ...
                        setupMessageHandler() {
                            ...
                            t.on('StartRenderPage', (t) => {
                                ...
                                this.#n.get(t.pageIndex)._startRenderPage(t.transparency, t.cacheKey);
                            });
                                ...
                                if (!this.destroyed && !this.commonObjs.has(e))
                                    switch (s) {
                                        case 'Font':
                                            ...
                                            this.fontLoader
                                                .bind(a)
                                                .catch((s) => t.sendWithPromise('FontFallback', { id: e }))
                                                .finally(() => {
                                    ...
                                    switch (s) {
                                        case 'Image':
                                            ...
                                            if (n) {
                                                let t;
                                                if (n.bitmap) {
                                                    const { bitmap: e, width: s, height: r } = n;
                                                    t = s * r * 4;
                                                    i._bitmaps.add(e);
                        ...
                        getFieldObjects() {
                            return (this._getFieldObjectsPromise ||= this.messageHandler.sendWithPromise(
                                'GetFieldObjects',
                                null
                            ));
                        }
                        ...
                        getMetadata() {
                            return (this.#r ||= this.messageHandler
                    ...
                    class PDFObjects {
                        ...
                        #o(t) {
                            const e = this.#a[t];
                            return e || (this.#a[t] = { capability: (0, _util.createPromiseCapability)(), data: null });
                        }
                        get(t, e = null) {
                            if (e) {
                                const s = this.#o(t);
                        ...
                        has(t) {
                            return this.#a[t]?.capability.settled || !1;
                        }
                        resolve(t, e = null) {
                            const s = this.#o(t);
                            s.data = e;
                    ...
                    class RenderTask {
                        ...
                        get separateAnnots() {
                            const { separateAnnots: t } = this.#l.operatorList;
                            if (!t) return !1;
                            const { annotationCanvasMap: e } = this.#l;
                    ...
                    class InternalRenderTask {
                        ...
                        initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
                            ...
                            this.gfx.beginDrawing({ transform: i, viewport: n, transparency: t, background: a });
                ...
                (t, e, s) => {
                    ...
                    class AnnotationStorage {
                        ...
                        remove(t) {
                            ...
                            if ('function' == typeof this.onAnnotationEditor) {
                                for (const t of this._storage.values()) if (t instanceof i.AnnotationEditor) return;
                                this.onAnnotationEditor(null);
                            }
                        }
                        setValue(t, e) {
                    ...
                    class PrintAnnotationStorage extends AnnotationStorage {
                        ...
                        constructor(t) {
                            super();
                            this.#d = structuredClone(t.serializable);
                        }
                        get print() {
                ...
                (t, e, s) => {
                    ...
                    class AnnotationEditor {
                        ...
                        #p = this.focusout.bind(this);
                        #g = !1;
                        #f = !1;
                        #m = !1;
                        #b = AnnotationEditor._zIndex++;
                        ...
                        focusin(t) {
                            this.#g ? (this.#g = !1) : this.parent.setSelected(this);
                        }
                        focusout(t) {
                        ...
                        translate(t, e) {
                            const [s, n] = this.parent.viewportBaseDimensions;
                        ...
                        render() {
                            ...
                            this.div.addEventListener('focusout', this.#p);
                        ...
                        pointerdown(t) {
                            const e = n.KeyboardManager.platform.isMac;
                        ...
                        getRect(t, e) {
                            const [s, n] = this.parent.viewportBaseDimensions,
                                [i, r] = this.parent.pageDimensions,
                                a = (i * t) / s,
                                o = (r * e) / n,
                                l = this.x * i,
                                c = this.y * r,
                        ...
                        static deserialize(t, e) {
                            const s = new this.prototype.constructor({ parent: e, id: e.getNextId() });
                            s.rotation = t.rotation;
                            const [n, i] = e.pageDimensions,
                                [r, a, o, l] = s.getRectInCurrentCoords(t.rect, i);
                            s.x = r / n;
                            s.y = a / i;
                            s.width = o / n;
                            s.height = l / i;
                        ...
                        remove() {
                            ...
                            this.div.removeEventListener('focusout', this.#p);
                ...
                (t, e, s) => {
                    ...
                    class IdManager {
                        #A = 0;
                        getId() {
                            return `${n.AnnotationEditorPrefix}${this.#A++}`;
                        }
                    }
                    class CommandManager {
                        ...
                        add({
                            ...
                            if (i && this.#_[this.#S].type === n) {
                                r && (a.undo = this.#_[this.#S].undo);
                                this.#_[this.#S] = a;
                                return;
                            }
                            const o = this.#S + 1;
                            if (o === this.#v) this.#_.splice(0, 1);
                            else {
                                this.#S = o;
                                o < this.#_.length && this.#_.splice(o);
                            }
                            this.#_.push(a);
                        }
                        undo() {
                    ...
                    class KeyboardManager {
                        ...
                        static get platform() {
                            const t = 'undefined' != typeof navigator ? navigator.platform : '';
                        ...
                        exec(t, e) {
                            ...
                            const s = this.callbacks.get(this.#x(e));
                            if (s) {
                                s.bind(t)();
                                e.stopPropagation();
                                e.preventDefault();
                    ...
                    class ClipboardManager {
                        ...
                        copy(t) {
                            if (t) {
                                Array.isArray(t)
                                    ? (this.#E = t.map((t) => t.serialize()))
                                    : (this.#E = [t.serialize()]);
                                this.#E = this.#E.filter((t) => !!t);
                                0 === this.#E.length && (this.#E = null);
                            }
                        }
                        paste() {
                            return this.#E;
                    ...
                    class ColorManager {
                        ...
                        convert(t) {
                            ...
                            for (const [t, s] of this._colors)
                                if (s.every((t, s) => t === e[s])) return ColorManager._colorsMapping.get(t);
                            return e;
                        }
                        getHexCode(t) {
                    ...
                    class AnnotationEditorUIManager {
                        ...
                        static _keyboardManager = new KeyboardManager([
                            ...
                            [['ctrl+y', 'ctrl+shift+Z', 'mac+meta+shift+Z'], AnnotationEditorUIManager.prototype.redo],
                            [
                                [
                                    'Backspace',
                                    'alt+Backspace',
                        ...
                        constructor(t, e) {
                            this.#q = t;
                            this.#R = e;
                            this.#R._on('editingaction', this.#B);
                            this.#R._on('pagechanging', this.#j);
                        }
                        destroy() {
                            this.#W();
                            this.#R._off('editingaction', this.#B);
                            this.#R._off('pagechanging', this.#j);
                        ...
                        #z() {
                            this.#q.addEventListener('keydown', this.#N);
                        }
                        #W() {
                            this.#q.removeEventListener('keydown', this.#N);
                        }
                        keydown(t) {
                        ...
                        #G(t) {
                            Object.entries(t).some(([t, e]) => this.#U[t] !== e) &&
                                this.#R.dispatch('annotationeditorstateschanged', {
                                    source: this,
                                    details: Object.assign(this.#U, t),
                                });
                        }
                        #H(t) {
                            this.#R.dispatch('annotationeditorparamschanged', { source: this, details: t });
                        }
                        setEditingState(t) {
                            if (t) {
                                this.#z();
                                this.#G({
                                    isEditing: this.#O !== n.AnnotationEditorType.NONE,
                                    isEmpty: this.#V(),
                                    hasSomethingToUndo: this.#k.hasSomethingToUndo(),
                                    hasSomethingToRedo: this.#k.hasSomethingToRedo(),
                                    hasSelectedEditor: !1,
                                    hasEmptyClipboard: this.#w.isEmpty(),
                                });
                            } else {
                                this.#W();
                                this.#G({ isEditing: !1 });
                        ...
                        registerEditorTypes(t) {
                            this.#M = t;
                            for (const t of this.#M) this.#H(t.defaultPropertiesToUpdate);
                        }
                        getId() {
                            return this.#D.getId();
                        }
                        addLayer(t) {
                            this.#T.set(t.pageIndex, t);
                            this.#I ? t.enable() : t.disable();
                        }
                        removeLayer(t) {
                            this.#T.delete(t.pageIndex);
                        }
                        updateMode(t) {
                            this.#O = t;
                            if (t === n.AnnotationEditorType.NONE) {
                                ...
                                this.#$();
                                for (const e of this.#T.values()) e.updateMode(t);
                            }
                        }
                        updateToolbar(t) {
                            t !== this.#O && this.#R.dispatch('switchannotationeditormode', { source: this, mode: t });
                        }
                        updateParams(t, e) {
                        ...
                        #$() {
                            if (!this.#I) {
                                this.#I = !0;
                                for (const t of this.#T.values()) t.enable();
                            }
                        }
                        #X() {
                            this.unselectAll();
                            if (this.#I) {
                                this.#I = !1;
                                for (const t of this.#T.values()) t.disable();
                            }
                        }
                        getEditors(t) {
                            const e = [];
                            for (const s of this.#P.values()) s.pageIndex === t && e.push(s);
                            return e;
                        }
                        getEditor(t) {
                            return this.#P.get(t);
                        ...
                        #Y(t) {
                            const e = this.#T.get(t.pageIndex);
                            e ? e.addOrRebuild(t) : this.addEditor(t);
                        }
                        setActiveEditor(t) {
                            if (this.#C !== t) {
                                this.#C = t;
                                t && this.#H(t.propertiesToUpdate);
                            }
                        }
                        toggleSelected(t) {
                            if (this.#L.has(t)) {
                                this.#L.delete(t);
                                t.unselect();
                                this.#G({ hasSelectedEditor: this.hasSelection });
                            } else {
                                this.#L.add(t);
                                t.select();
                                this.#H(t.propertiesToUpdate);
                                this.#G({ hasSelectedEditor: !0 });
                            }
                        }
                        setSelected(t) {
                        ...
                        addCommands(t) {
                            this.#k.add(t);
                            this.#G({ hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#V() });
                        }
                        #V() {
                        ...
                        copy() {
                            ...
                            if (this.hasSelection) {
                                const t = [];
                                for (const e of this.#L) e.isEmpty() || t.push(e);
                                if (0 === t.length) return;
                                this.#w.copy(t);
                                this.#G({ hasEmptyClipboard: !1 });
                            }
                        }
                        cut() {
                            this.copy();
                        ...
                        paste() {
                            if (this.#w.isEmpty()) return;
                            this.unselectAll();
                            const t = this.#T.get(this.#F),
                                e = this.#w.paste().map((e) => t.deserialize(e));
                            this.addCommands({
                                cmd: () => {
                                    for (const t of e) this.#Y(t);
                                    this.#K(e);
                                },
                                undo: () => {
                        ...
                        selectAll() {
                            ...
                            this.#K(this.#P.values());
                        }
                        unselectAll() {
                            if (this.#C) this.#C.commitOrRemove();
                            else if (0 !== this.#K.size) {
                                for (const t of this.#L) t.unselect();
                                this.#L.clear();
                                this.#G({ hasSelectedEditor: !1 });
                            }
                        }
                        isActive(t) {
                            return this.#C === t;
                ...
                (t, e, s) => {
                    ...
                    e.getCurrentTransform = function getCurrentTransform(t) {
                        const { a: e, b: s, c: n, d: i, e: r, f: a } = t.getTransform();
                        return [e, s, n, i, r, a];
                    };
                    e.getCurrentTransformInverse = function getCurrentTransformInverse(t) {
                        const { a: e, b: s, c: n, d: i, e: r, f: a } = t.getTransform().invertSelf();
                        return [e, s, n, i, r, a];
                    };
                    ...
                    e.getPdfFilenameFromUrl = function getPdfFilenameFromUrl(t, e = 'document.pdf') {
                        ...
                        const s = /[^/?#=]+\.pdf\b(?!.*\.pdf\b)/i,
                            n = /^(?:(?:[^:]+:)?\/\/[^/]+)?([^?#]*)(\?[^#]*)?(#.*)?$/.exec(t);
                        let r = s.exec(n[1]) || s.exec(n[2]) || s.exec(n[3]);
                        if (r) {
                            r = r[0];
                            if (r.includes('%'))
                                try {
                    ...
                    e.getRGB = getRGB;
                    e.getXfaPageViewport = function getXfaPageViewport(t, { scale: e = 1, rotation: s = 0 }) {
                        const { width: n, height: i } = t.attributes.style,
                            r = [0, 0, parseInt(n), parseInt(i)];
                    ...
                    async function fetchData(t, e = !1) {
                        if (isValidFetchUrl(t, document.baseURI)) {
                            ...
                            return e ? new Uint8Array(await s.arrayBuffer()) : (0, i.stringToBytes)(await s.text());
                        }
                        return new Promise((s, n) => {
                                ...
                                if (r.readyState === XMLHttpRequest.DONE) {
                                    if (200 === r.status || 0 === r.status) {
                                        ...
                                        e && r.response
                                            ...
                                            : !e && r.responseText && (t = (0, i.stringToBytes)(r.responseText));
                                        if (t) {
                                            s(t);
                                            return;
                                        }
                    ...
                    class PageViewport {
                        constructor({
                            ...
                            if (0 === l) {
                                ...
                                p = Math.abs(a - t[0]) * e + i;
                                g = Math.abs(t[3] - t[1]) * e;
                                f = Math.abs(t[2] - t[0]) * e;
                            } else {
                                u = Math.abs(a - t[0]) * e + n;
                    ...
                    e.StatTimer = class StatTimer {
                        ...
                        time(t) {
                            t in this.started && (0, i.warn)(`Timer is already running for ${t}`);
                            this.started[t] = Date.now();
                        }
                        timeEnd(t) {
                            t in this.started || (0, i.warn)(`Timer has not been started for ${t}`);
                    ...
                    e.PDFDateString = class PDFDateString {
                        static toDateObject(t) {
                            ...
                            return new Date(Date.UTC(s, n, i, a, o, l));
                        }
                    };
                    function getRGB(t) {
                        if (t.startsWith('#')) {
                ...
                (t, e, s) => {
                    ...
                    class BaseFontLoader {
                        ...
                        async bind(t) {
                            ...
                            if (e) {
                                ...
                                await new Promise((s) => {
                                    ...
                                    this._prepareFontLoadEvent([e], [t], n);
                                });
                            }
                        }
                        ...
                        _prepareFontLoadEvent(t, e, s) {
                            (0, n.unreachable)('Abstract method `_prepareFontLoadEvent`.');
                        }
                    }
                    let i;
                    e.FontLoader = i;
                    e.FontLoader = i = class GenericFontLoader extends BaseFontLoader {
                        constructor(t) {
                            super(t);
                        ...
                        get isSyncFontLoadingSupported() {
                            ...
                            if ('undefined' == typeof navigator) t = !0;
                                ...
                                /Mozilla\/5.0.*?rv:(\d+).*? Gecko/.exec(navigator.userAgent)?.[1] >= 14 && (t = !0);
                            }
                        ...
                        _prepareFontLoadEvent(t, e, s) {
                            ...
                            const d = 1482184792;
                            let u = int32(h, 16);
                            for (i = 0, r = c.length - 3; i < r; i += 4) u = (u - d + int32(c, i)) | 0;
                            i < c.length && (u = (u - d + int32(c + 'XXX', i)) | 0);
                            ...
                            this.insertRule(p);
                            const g = [];
                            for (const t of e) g.push(t.loadedName);
                            g.push(c);
                ...
                (t, e, s) => {
                    ...
                    function drawImageAtIntegerCoords(t, e, s, i, r, a, o, l, c, h) {
                        const [d, u, p, g, f, m] = (0, n.getCurrentTransform)(t);
                        if (0 === u && 0 === p) {
                            const n = o * d + f,
                                b = Math.round(n),
                                A = l * g + m,
                    ...
                    function composeSMask(t, e, s, n) {
                        const i = n[0],
                            ...
                            o = n[3] - r;
                        if (0 !== a && 0 !== o) {
                            !(function genericComposeSMask(t, e, s, n, i, r, a, o, l, c, h) {
                                const d = !!r,
                                    u = d ? r[0] : 0,
                                    p = d ? r[1] : 0,
                                    g = d ? r[2] : 0;
                                let f;
                                f = 'Luminosity' === i ? composeSMaskLuminosity : composeSMaskAlpha;
                                const m = Math.min(n, Math.ceil(1048576 / s));
                                for (let i = 0; i < n; i += m) {
                                    const r = Math.min(m, n - i),
                                        b = t.getImageData(o - c, i + (l - h), s, r),
                                        A = e.getImageData(o, i + l, s, r);
                                    d && composeSMaskBackdrop(b.data, u, p, g);
                                    f(b.data, A.data, a);
                                    e.putImageData(A, o, i + l);
                                }
                            })(e.context, s, a, o, e.subtype, e.backdrop, e.transferMap, i, r, e.offsetX, e.offsetY);
                            t.save();
                            t.globalAlpha = 1;
                            t.globalCompositeOperation = 'source-over';
                    ...
                    function getImageSmoothingEnabled(t, e) {
                        ...
                        s[0] = Math.fround(s[0]);
                        s[1] = Math.fround(s[1]);
                        const r = Math.fround((globalThis.devicePixelRatio || 1) * n.PixelsPerInch.PDF_TO_CSS_UNITS);
                    ...
                    class CanvasGraphics {
                            ...
                            if (this.foregroundColor && this.backgroundColor) {
                                ...
                                if (('#000000' === t && '#ffffff' === e) || t === e || !s)
                                    ...
                                    const [s, r, a] = (0, n.getRGB)(i),
                                        ...
                                        o = Math.round(0.2126 * newComp(s) + 0.7152 * newComp(r) + 0.0722 * newComp(a));
                                    this.selectColor = (s, n, i) => {
                                        const r = 0.2126 * newComp(s) + 0.7152 * newComp(n) + 0.0722 * newComp(i);
                        ...
                        _createMaskCanvas(t) {
                            ...
                            v.transform(...g);
                            if (!u) {
                                u = this._scaleImage(p.canvas, (0, n.getCurrentTransformInverse)(v));
                                u = u.img;
                                h && l && h.set(d, u);
                            }
                            ...
                            drawImageAtIntegerCoords(v, u, 0, 0, u.width, u.height, 0, 0, s, a);
                            v.globalCompositeOperation = 'source-in';
                            const E = i.Util.transform((0, n.getCurrentTransformInverse)(v), [1, 0, 0, 1, -S, -x]);
                            v.fillStyle = l ? o.getPattern(e, this, E, r.PathType.FILL) : o;
                            v.fillRect(0, 0, s, a);
                            if (h && !l) {
                                this.cachedCanvases.delete('fillCanvas');
                                h.set(d, y.canvas);
                            }
                            return { canvas: y.canvas, offsetX: Math.round(S), offsetY: Math.round(x) };
                        }
                        setLineWidth(t) {
                        ...
                        beginSMaskMode() {
                            ...
                            !(function mirrorContextOperations(t, e) {
                                ...
                                t.transform = function ctxTransform(t, s, n, i, r, a) {
                                    e.transform(t, s, n, i, r, a);
                                    this.__originalTransform(t, s, n, i, r, a);
                                };
                                t.setTransform = function ctxSetTransform(t, s, n, i, r, a) {
                                    e.setTransform(t, s, n, i, r, a);
                                    this.__originalSetTransform(t, s, n, i, r, a);
                                };
                                ...
                                t.bezierCurveTo = function (t, s, n, i, r, a) {
                                    e.bezierCurveTo(t, s, n, i, r, a);
                                    this.__originalBezierCurveTo(t, s, n, i, r, a);
                                };
                        ...
                        transform(t, e, s, n, i, r) {
                            this.ctx.transform(t, e, s, n, i, r);
                            this._cachedScaleForStroking = null;
                            this._cachedGetSinglePixelWidth = null;
                        }
                        constructPath(t, e, s) {
                                ...
                                switch (0 | t[s]) {
                                    case i.OPS.rectangle:
                                        ...
                                        const t = e[n++],
                                            ...
                                            f = h + s;
                                        r.moveTo(c, h);
                                        if (0 === t || 0 === s) r.lineTo(g, f);
                                        else {
                                            r.lineTo(g, h);
                                            r.lineTo(g, f);
                                            r.lineTo(c, f);
                                        }
                                        u || a.updateRectMinMax(d, [c, h, g, f]);
                                        r.closePath();
                                        break;
                                    case i.OPS.moveTo:
                                        c = e[n++];
                                    ...
                                    case i.OPS.curveTo:
                                        ...
                                        a.updateCurvePathMinMax(d, o, l, e[n], e[n + 1], e[n + 2], e[n + 3], c, h, p);
                                        n += 6;
                                        break;
                                    case i.OPS.curveTo2:
                                        o = c;
                                        ...
                                        a.updateCurvePathMinMax(d, o, l, c, h, e[n], e[n + 1], e[n + 2], e[n + 3], p);
                                        c = e[n + 2];
                                        h = e[n + 3];
                                        n += 4;
                                        break;
                                    case i.OPS.curveTo3:
                                        ...
                                        a.updateCurvePathMinMax(d, o, l, e[n], e[n + 1], c, h, c, h, p);
                                        n += 4;
                                        break;
                        ...
                        setTextMatrix(t, e, s, n, i, r) {
                            this.current.textMatrix = [t, e, s, n, i, r];
                        ...
                        paintChar(t, e, s, r) {
                            ...
                            if (l.disableFontFace || p) {
                                ...
                                (d !== i.TextRenderingMode.STROKE && d !== i.TextRenderingMode.FILL_STROKE) ||
                                    a.stroke();
                                a.restore();
                            } else {
                                (d !== i.TextRenderingMode.FILL && d !== i.TextRenderingMode.FILL_STROKE) ||
                                    a.fillText(t, e, s);
                                (d !== i.TextRenderingMode.STROKE && d !== i.TextRenderingMode.FILL_STROKE) ||
                                    a.strokeText(t, e, s);
                            }
                        ...
                        showText(t) {
                            ...
                            if (0 === v || 0 === y) {
                                ...
                                (t !== i.TextRenderingMode.STROKE && t !== i.TextRenderingMode.FILL_STROKE) ||
                            ...
                            for (S = 0; S < p; ++S) {
                                ...
                                if (this.contentVisible && (e.isInFont || s.missingFile))
                                    if (A && !u) o.fillText(r, p, y);
                                    else {
                                        this.paintChar(r, p, y, _);
                                        if (u) {
                        ...
                        showType3Text(t) {
                            const e = this.ctx,
                                ...
                                u = t.length;
                            let p, g, f, m;
                            if (!(s.textRenderingMode === i.TextRenderingMode.INVISIBLE) && 0 !== r) {
                                this._cachedScaleForStroking = null;
                                this._cachedGetSinglePixelWidth = null;
                                e.save();
                                ...
                                for (p = 0; p < u; ++p) {
                                    ...
                                    f = i.Util.applyTransform([g.width, 0], d)[0] * r + a;
                                    e.translate(f, 0);
                                    s.x += f * h;
                                }
                                e.restore();
                        ...
                        setCharWidth(t, e) {}
                        setCharWidthAndBounds(t, e, s, n, i, r) {
                            this.ctx.rect(s, n, i - s, r - n);
                            this.ctx.clip();
                            this.endPath();
                        }
                        getColorN_Pattern(t) {
                        ...
                        setStrokeRGBColor(t, e, s) {
                            const n = this.selectColor?.(t, e, s) || i.Util.makeHexColor(t, e, s);
                        ...
                        beginGroup(t) {
                            ...
                            let r = i.Util.getAxialAlignedBoundingBox(t.bbox, (0, n.getCurrentTransform)(e));
                        ...
                        paintImageMaskXObject(t) {
                            ...
                            s.drawImage(r, i.offsetX, i.offsetY);
                            s.restore();
                            this.compose();
                        }
                        ...
                        paintImageMaskXObjectGroup(t) {
                            ...
                            for (const a of t) {
                                ...
                                d.fillStyle = i
                                    ? s.getPattern(d, this, (0, n.getCurrentTransformInverse)(e), r.PathType.FILL)
                                    : s;
                                d.fillRect(0, 0, o, l);
                                d.restore();
                                e.save();
                        ...
                        paintImageXObjectRepeat(t, e, s, n) {
                            ...
                            for (let t = 0, i = n.length; t < i; t += 2)
                                l.push({ transform: [e, 0, 0, s, n[t], n[t + 1]], x: 0, y: 0, w: a, h: o });
                        ...
                        paintInlineImageXObject(t) {
                            ...
                            r.scale(1 / e, -1 / s);
                            let a;
                            if (('function' == typeof HTMLElement && t instanceof HTMLElement) || !t.data) a = t;
                            else {
                                const n = this.cachedCanvases.getCanvas('inlineImage', e, s);
                                putBinaryImageData(n.context, t, this.current.transferMaps);
                                a = n.canvas;
                            }
                            const o = this._scaleImage(a, (0, n.getCurrentTransformInverse)(r));
                            r.imageSmoothingEnabled = getImageSmoothingEnabled(
                                (0, n.getCurrentTransform)(r),
                                t.interpolate
                            );
                            ...
                            if (this.imageLayer) {
                                const [e, r] = i.Util.applyTransform([0, -s], (0, n.getCurrentTransform)(this.ctx));
                                this.imageLayer.appendImage({ imgData: t, left: e, top: r, width: l, height: c });
                            }
                            this.compose();
                            this.restore();
                        }
                        paintInlineImageXObjectGroup(t, e) {
                            ...
                            const s = this.ctx,
                                r = t.width,
                                a = t.height,
                                o = this.cachedCanvases.getCanvas('inlineImage', r, a);
                            putBinaryImageData(o.context, t, this.current.transferMaps);
                            for (const l of e) {
                                s.save();
                                s.transform(...l.transform);
                                s.scale(1, -1);
                                drawImageAtIntegerCoords(s, o.canvas, l.x, l.y, l.w, l.h, 0, -1, 1, 1);
                                if (this.imageLayer) {
                                    const [e, s] = i.Util.applyTransform(
                                        [l.x, l.y],
                                        (0, n.getCurrentTransform)(this.ctx)
                                    );
                                    this.imageLayer.appendImage({ imgData: t, left: e, top: s, width: r, height: a });
                                }
                                s.restore();
                            }
                            this.compose();
                    ...
                    for (const t in i.OPS)
                        void 0 !== CanvasGraphics.prototype[t] &&
                            (CanvasGraphics.prototype[i.OPS[t]] = CanvasGraphics.prototype[t]);
                },
                (t, e, s) => {
                    Object.defineProperty(e, '__esModule', { value: !0 });
                    ...
                    class RadialAxialShadingPattern extends BaseShadingPattern {
                        ...
                        getPattern(t, e, s, r) {
                            ...
                            if (r === a.STROKE || r === a.FILL) {
                                const a = e.current.getClippedPathBoundingBox(r, (0, i.getCurrentTransform)(t)) || [
                                        0, 0, 0, 0,
                                    ],
                                ...
                                d.translate(-a[0], -a[1]);
                                s = n.Util.transform(s, [1, 0, 0, 1, a[0], a[1]]);
                                ...
                                try {
                                    ...
                                    (0, n.warn)(`RadialAxialShadingPattern.getPattern: "${t?.message}".`);
                                }
                            } else {
                    ...
                    function drawTriangle(t, e, s, n, i, r, a, o) {
                        const l = e.coords,
                            c = e.colors,
                            h = t.data,
                            d = 4 * t.width;
                        ...
                        switch (e.type) {
                            case 'lattice':
                                ...
                                for (r = 0; r < l; r++) {
                                    let e = r * o;
                                    for (let r = 0; r < c; r++, e++) {
                                        drawTriangle(t, s, n[e], n[e + 1], n[e + o], i[e], i[e + 1], i[e + o]);
                                        drawTriangle(
                                            t,
                                            s,
                                            n[e + o + 1],
                            ...
                            case 'triangles':
                                for (r = 0, a = n.length; r < a; r += 3)
                                    drawTriangle(t, s, n[r], n[r + 1], n[r + 2], i[r], i[r + 1], i[r + 2]);
                                break;
                            default:
                    ...
                    class MeshShadingPattern extends BaseShadingPattern {
                        ...
                        _createMeshCanvas(t, e, s) {
                            ...
                            return { canvas: g.canvas, offsetX: n - 2 * c, offsetY: i - 2 * h, scaleX: c, scaleY: h };
                        }
                        getPattern(t, e, s, r) {
                            applyBoundingBox(t, this._bbox);
                            let o;
                            if (r === a.SHADING)
                                o = n.Util.singularValueDecompose2dScale((0, i.getCurrentTransform)(t));
                            else {
                    ...
                    class TilingPattern {
                        ...
                        createPatternCanvas(t) {
                            ...
                            S.endDrawing();
                            return { canvas: y.canvas, scaleX: A.scale, scaleY: _.scale, offsetX: x, offsetY: E };
                        }
                        ...
                        clipBbox(t, e, s, n, r) {
                            const a = n - e,
                                o = r - s;
                            t.ctx.rect(e, s, a, o);
                            t.current.updateRectMinMax((0, i.getCurrentTransform)(t.ctx), [e, s, n, r]);
                            t.clip();
                            t.endPath();
                        }
                        setFillAndStrokeStyleToContext(t, e, s) {
                            ...
                            switch (e) {
                                case o:
                                    ...
                                    break;
                                case l:
                                    const a = n.Util.makeHexColor(s[0], s[1], s[2]);
                                    i.fillStyle = a;
                                    i.strokeStyle = a;
                                    r.fillColor = a;
                                    r.strokeColor = a;
                        ...
                        getPattern(t, e, s, i) {
                            ...
                            try {
                                ...
                                (0, n.warn)(`TilingPattern.getPattern: "${t?.message}".`);
                            }
                            return c;
                        }
                    }
                            ...
                            const e = t.streamId,
                                ...
                                d = {
                                    enqueue(t, a = 1, o) {
                                        ...
                                        r.postMessage(
                                            { sourceName: s, targetName: i, stream: c, streamId: e, chunk: t },
                                            o
                                        );
                                    },
                                    close() {
                                        if (!this.isCancelled) {
                                            this.isCancelled = !0;
                                            r.postMessage({ sourceName: s, targetName: i, stream: l, streamId: e });
                        ...
                        _processStreamMessage(t) {
                            ...
                            switch (t.stream) {
                                ...
                                case a:
                                    if (!f) break;
                                    new Promise(function (e) {
                                        e(f.onCancel && f.onCancel(wrapReason(t.reason)));
                                    }).then(
                                        function () {
                                            r.postMessage({
                                                sourceName: s,
                ...
                (t, e, s) => {
                    ...
                    e.Metadata = class Metadata {
                        ...
                        get(t) {
                            return this.#Q.get(t) ?? null;
                        }
                        getAll() {
                            return (0, n.objectFromMap)(this.#Q);
                        }
                        has(t) {
                            return this.#Q.has(t);
                        }
                ...
                (t, e, s) => {
                    ...
                    class OptionalContentGroup {
                        ...
                        _setVisible(t, e) {
                            t !== i && (0, n.unreachable)('Internal method `_setVisible` called.');
                            this.#tt = e;
                        }
                    }
                    e.OptionalContentConfig = class OptionalContentConfig {
                        ...
                        constructor(t) {
                            ...
                            if (null !== t) {
                                ...
                                for (const e of t.groups)
                                    this.#st.set(e.id, new OptionalContentGroup(e.name, e.intent));
                                if ('OFF' === t.baseState) for (const t of this.#st.values()) t._setVisible(i, !1);
                                for (const e of t.on) this.#st.get(e)._setVisible(i, !0);
                                for (const e of t.off) this.#st.get(e)._setVisible(i, !1);
                                this.#nt = new Map();
                                for (const [t, e] of this.#st) this.#nt.set(t, e.visible);
                            }
                        }
                        #rt(t) {
                            const e = t.length;
                            ...
                            for (let i = 1; i < e; i++) {
                                const e = t[i];
                                let r;
                                if (Array.isArray(e)) r = this.#rt(e);
                                else {
                                    if (!this.#st.has(e)) {
                                        (0, n.warn)(`Optional content group not found: ${e}`);
                                        return !0;
                                    }
                                    r = this.#st.get(e).visible;
                                }
                                switch (s) {
                                    case 'And':
                                        if (!r) return !1;
                        ...
                        isVisible(t) {
                            ...
                            if ('OCG' === t.type) {
                                ...
                                return this.#st.get(t.id).visible;
                            }
                            if ('OCMD' === t.type) {
                                if (t.expression) return this.#rt(t.expression);
                                if (!t.policy || 'AnyOn' === t.policy) {
                                    for (const e of t.ids) {
                                        ...
                                        if (this.#st.get(e).visible) return !0;
                                    }
                                    return !1;
                                }
                                if ('AllOn' === t.policy) {
                                    for (const e of t.ids) {
                                        ...
                                        if (!this.#st.get(e).visible) return !1;
                                    }
                                    return !0;
                                }
                                if ('AnyOff' === t.policy) {
                        ...
                        setVisibility(t, e = !0) {
                            if (this.#st.has(t)) {
                                this.#st.get(t)._setVisible(i, !!e);
                                this.#et = null;
                            } else (0, n.warn)(`Optional content group not found: ${t}`);
                        }
                        get hasInitialVisibility() {
                            if (null !== this.#et) return this.#et;
                            for (const [t, e] of this.#st) {
                                const s = this.#nt.get(t);
                                if (e.visible !== s) return (this.#et = !1);
                            }
                            return (this.#et = !0);
                        }
                        getOrder() {
                            return this.#st.size ? (this.#it ? this.#it.slice() : [...this.#st.keys()]) : null;
                        }
                        getGroups() {
                            return this.#st.size > 0 ? (0, n.objectFromMap)(this.#st) : null;
                        }
                        getGroup(t) {
                            return this.#st.get(t) || null;
                        }
                    };
                },
                (t, e, s) => {
                    ...
                    e.PDFDataTransportStream = class PDFDataTransportStream {
                        ...
                        _onProgress(t) {
                            if (void 0 === t.total) {
                                ...
                                e?.onProgress && e.onProgress({ loaded: t.loaded, total: t.total });
                            }
                        }
                        _onProgressiveDone() {
                ...
                (t, e, s) => {
                    ...
                    class AnnotationEditorLayer {
                        ...
                        constructor(t) {
                            ...
                            this.#pt.addLayer(this);
                        }
                        updateToolbar(t) {
                            this.#pt.updateToolbar(t);
                        }
                        updateMode(t = this.#pt.getMode()) {
                            this.#gt();
                        ...
                        addInkEditorIfNeeded(t) {
                            if (!t && this.#pt.getMode() !== i.AnnotationEditorType.INK) return;
                            if (!t)
                            ...
                            this.#ft({ offsetX: 0, offsetY: 0 }).setInBackground();
                        }
                        setEditingState(t) {
                            this.#pt.setEditingState(t);
                        }
                        addCommands(t) {
                            this.#pt.addCommands(t);
                        }
                        enable() {
                            this.div.style.pointerEvents = 'auto';
                            for (const t of this.#ht.values()) t.enableEditing();
                        }
                        disable() {
                            this.div.style.pointerEvents = 'none';
                            for (const t of this.#ht.values()) t.disableEditing();
                        }
                        setActiveEditor(t) {
                            this.#pt.getActive() !== t && this.#pt.setActiveEditor(t);
                        }
                        enableClick() {
                            this.div.addEventListener('pointerdown', this.#ct);
                            this.div.addEventListener('pointerup', this.#lt);
                        }
                        disableClick() {
                            this.div.removeEventListener('pointerdown', this.#ct);
                            this.div.removeEventListener('pointerup', this.#lt);
                        }
                        attach(t) {
                            this.#ht.set(t.id, t);
                        }
                        ...
                        remove(t) {
                            ...
                            setTimeout(() => {
                                ...
                                t.div.remove();
                                t.isAttachedToDOM = !1;
                                document.activeElement === document.body && this.#pt.focusMainContainer();
                            }, 0);
                            this.#ut || this.addInkEditorIfNeeded(!1);
                        }
                        #mt(t) {
                            if (t.parent !== this) {
                                this.attach(t);
                        ...
                        addToAnnotationStorage(t) {
                            t.isEmpty() || this.annotationStorage.has(t.id) || this.annotationStorage.setValue(t.id, t);
                        }
                        addOrRebuild(t) {
                        ...
                        getNextId() {
                            return this.#pt.getId();
                        }
                        #bt(t) {
                            switch (this.#pt.getMode()) {
                        ...
                        #ft(t) {
                            const e = this.getNextId(),
                                s = this.#bt({ parent: this, id: e, x: t.offsetX, y: t.offsetY });
                            s && this.add(s);
                            return s;
                        }
                        setSelected(t) {
                            this.#pt.setSelected(t);
                        }
                        toggleSelected(t) {
                            this.#pt.toggleSelected(t);
                        }
                        isSelected(t) {
                            return this.#pt.isSelected(t);
                        }
                        unselect(t) {
                            this.#pt.unselect(t);
                        }
                        pointerup(t) {
                            const e = n.KeyboardManager.platform.isMac;
                            if (!(0 !== t.button || (t.ctrlKey && e)) && t.target === this.div && this.#dt) {
                                this.#dt = !1;
                                this.#ot ? this.#ft(t) : (this.#ot = !0);
                            }
                        }
                        pointerdown(t) {
                            const e = n.KeyboardManager.platform.isMac;
                            ...
                            this.#dt = !0;
                            const s = this.#pt.getActive();
                            this.#ot = !s || s.isEmpty();
                        }
                        drop(t) {
                            const e = t.dataTransfer.getData('text/plain'),
                                s = this.#pt.getEditor(e);
                            if (!s) return;
                            t.preventDefault();
                            ...
                            const n = this.div.getBoundingClientRect(),
                                i = t.clientX - n.x,
                                r = t.clientY - n.y;
                            s.translate(i - s.startX, r - s.startY);
                        ...
                        destroy() {
                            this.#pt.getActive()?.parent === this && this.#pt.setActiveEditor(null);
                            for (const t of this.#ht.values()) {
                                this.#at?.removePointerInTextLayer(t.contentDiv);
                                t.isAttachedToDOM = !1;
                                t.div.remove();
                            ...
                            this.div = null;
                            this.#ht.clear();
                            this.#pt.removeLayer(this);
                        }
                        #gt() {
                            this.#ut = !0;
                            for (const t of this.#ht.values()) t.isEmpty() && t.remove();
                            this.#ut = !1;
                        }
                        render(t) {
                            ...
                            this.setDimensions();
                            for (const t of this.#pt.getEditors(this.pageIndex)) this.add(t);
                            this.updateMode();
                        }
                        update(t) {
                            this.viewport = t.viewport;
                        ...
                        get pageDimensions() {
                            const [t, e, s, n] = this.viewport.viewBox;
                            return [s - t, n - e];
                        }
                        ...
                        setDimensions() {
                            const { width: t, height: e, rotation: s } = this.viewport,
                                ...
                                i = Math.floor(t) + 'px',
                                r = Math.floor(e) + 'px';
                            this.div.style.width = n ? r : i;
                            this.div.style.height = n ? i : r;
                ...
                (t, e, s) => {
                    ...
                    class FreeTextEditor extends r.AnnotationEditor {
                        #At = this.editorDivBlur.bind(this);
                        #_t = this.editorDivFocus.bind(this);
                        ...
                        constructor(t) {
                            ...
                            this.#vt = t.color || FreeTextEditor._defaultColor || r.AnnotationEditor._defaultLineColor;
                            this.#Et = t.fontSize || FreeTextEditor._defaultFontSize;
                        }
                        static initialize(t) {
                        ...
                        static get defaultPropertiesToUpdate() {
                            return [
                                ...
                                [
                                    ...
                                    FreeTextEditor._defaultColor || r.AnnotationEditor._defaultLineColor,
                                ],
                            ];
                        }
                        get propertiesToUpdate() {
                            return [
                                [n.AnnotationEditorParamsType.FREETEXT_SIZE, this.#Et],
                                [n.AnnotationEditorParamsType.FREETEXT_COLOR, this.#vt],
                            ];
                        }
                        #Ct(t) {
                            const setFontsize = (t) => {
                                    this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
                                    this.translate(0, -(t - this.#Et) * this.parent.scaleFactor);
                                    this.#Et = t;
                                    this.#Tt();
                                },
                                e = this.#Et;
                        ...
                        getInitialTranslation() {
                            return [
                                ...
                                -(FreeTextEditor._internalPadding + this.#Et) * this.parent.scaleFactor,
                            ];
                        }
                        rebuild() {
                            super.rebuild();
                        ...
                        enableEditMode() {
                            if (!this.isInEditMode()) {
                                ...
                                this.editorDiv.addEventListener('focus', this.#_t);
                                this.editorDiv.addEventListener('blur', this.#At);
                            }
                        }
                        disableEditMode() {
                            if (this.isInEditMode()) {
                                ...
                                this.editorDiv.removeEventListener('focus', this.#_t);
                                this.editorDiv.removeEventListener('blur', this.#At);
                                this.div.focus();
                                this.isEditing = !1;
                            }
                        }
                        ...
                        #wt() {
                            ...
                            const e = [];
                            for (let s = 0, n = t.length; s < n; s++) {
                                const n = t[s].firstChild;
                                '#text' === n?.nodeName ? e.push(n.data) : e.push('');
                            }
                            return e.join('\n');
                        }
                        #Tt() {
                        ...
                        render() {
                            ...
                            s.fontSize = `calc(${this.#Et}px * var(--scale-factor))`;
                            s.color = this.#vt;
                        ...
                        static deserialize(t, e) {
                            ...
                            s.#Et = t.fontSize;
                            s.#vt = n.Util.makeHexColor(...t.color);
                            s.#St = t.value;
                            return s;
                        }
                        serialize() {
                            ...
                            const t = FreeTextEditor._internalPadding * this.parent.scaleFactor,
                                e = this.getRect(t, t),
                                s = r.AnnotationEditor._colorManager.convert(getComputedStyle(this.editorDiv).color);
                            return {
                ...
                (t, e, s) => {
                    ...
                    class InkEditor extends i.AnnotationEditor {
                        ...
                        #Ft = 0;
                        #Mt = 0;
                        #Rt = this.canvasPointermove.bind(this);
                        #Dt = this.canvasPointerleave.bind(this);
                        #It = this.canvasPointerup.bind(this);
                        #Ot = this.canvasPointerdown.bind(this);
                        #Lt = !1;
                        #Nt = !1;
                        #Bt = null;
                        #jt = null;
                        ...
                        static get defaultPropertiesToUpdate() {
                            return [
                                ...
                                [
                                    ...
                                    InkEditor._defaultColor || i.AnnotationEditor._defaultLineColor,
                                ],
                        ...
                        get propertiesToUpdate() {
                            return [
                                ...
                                [
                                    n.AnnotationEditorParamsType.INK_COLOR,
                                    this.color || InkEditor._defaultColor || i.AnnotationEditor._defaultLineColor,
                                ],
                                [
                        ...
                        enableEditMode() {
                            if (!this.#Lt && null !== this.canvas) {
                                super.enableEditMode();
                                this.div.draggable = !1;
                                this.canvas.addEventListener('pointerdown', this.#Ot);
                                this.canvas.addEventListener('pointerup', this.#It);
                            }
                        }
                        disableEditMode() {
                            if (this.isInEditMode() && null !== this.canvas) {
                                ...
                                this.canvas.removeEventListener('pointerdown', this.#Ot);
                                this.canvas.removeEventListener('pointerup', this.#It);
                            }
                        }
                        onceAdded() {
                            this.div.draggable = !this.isEmpty();
                            ...
                            this.#Wt = () => {
                                if (this.#Wt) {
                                    if (this.#Bt) {
                                        ...
                                        this.ctx.lineTo(...this.#Bt);
                                        this.#Bt = null;
                                        this.ctx.stroke();
                                    }
                                    window.requestAnimationFrame(this.#Wt);
                                }
                            };
                            window.requestAnimationFrame(this.#Wt);
                        }
                        ...
                        #te(t, e) {
                            ...
                            let i;
                            if (1 !== this.currentPath.length) i = (0, r.fitCurve)(this.currentPath, 30, null);
                            else {
                                const s = [t, e];
                                i = [[s, s.slice(), s.slice(), s]];
                            }
                            const a = InkEditor.#ee(i);
                        ...
                        canvasPointerdown(t) {
                            if (0 === t.button && this.isInEditMode() && !this.#Lt) {
                                this.setInForeground();
                                'mouse' !== t.type && this.div.focus();
                                t.stopPropagation();
                                this.canvas.addEventListener('pointerleave', this.#Dt);
                                this.canvas.addEventListener('pointermove', this.#Rt);
                                this.#Qt(t.offsetX, t.offsetY);
                            }
                        }
                        canvasPointermove(t) {
                            t.stopPropagation();
                            this.#Zt(t.offsetX, t.offsetY);
                        }
                        canvasPointerup(t) {
                        ...
                        #ne(t) {
                            this.#te(t.offsetX, t.offsetY);
                            this.canvas.removeEventListener('pointerleave', this.#Dt);
                            this.canvas.removeEventListener('pointermove', this.#Rt);
                            this.parent.addToAnnotationStorage(this);
                        }
                        #Xt() {
                        ...
                        setDimensions(t, e) {
                            const s = Math.round(t),
                                n = Math.round(e);
                            if (this.#Ut === s && this.#qt === n) return;
                            this.#Ut = s;
                            this.#qt = n;
                            this.canvas.style.visibility = 'hidden';
                            if (this.#kt && Math.abs(this.#kt - t / e) > 0.01) {
                                e = Math.ceil(t / this.#kt);
                                this.setDims(t, e);
                            }
                            const [i, r] = this.parent.viewportBaseDimensions;
                            this.width = t / i;
                        ...
                        static #ee(t) {
                            ...
                            for (let s = 0, n = t.length; s < n; s++) {
                                const [n, i, r, a] = t[s];
                                0 === s && e.moveTo(...n);
                                e.bezierCurveTo(i[0], i[1], r[0], r[1], a[0], a[1]);
                            }
                            return e;
                        }
                        #oe(t, e, s, n) {
                            ...
                            for (const l of this.paths) {
                                ...
                                for (let i = 0, c = l.length; i < c; i++) {
                                    ...
                                    a.push(f, m, b, A, _, y);
                                    this.#le(p, g, f, m, b, A, _, y, 4, o);
                                }
                                i.push({ bezier: a, points: o });
                            }
                            return i;
                        }
                        #le(t, e, s, n, i, r, a, o, l, c) {
                            if (this.#ce(t, e, s, n, i, r, a, o)) c.push(a, o);
                            else {
                                for (let h = 1; h < l - 1; h++) {
                                    const d = h / l,
                                        u = 1 - d;
                        ...
                        #he() {
                            ...
                            for (const r of this.paths)
                                for (const [a, o, l, c] of r) {
                                    const r = n.Util.bezierBoundingBox(...a, ...o, ...l, ...c);
                                    t = Math.min(t, r[0]);
                                    s = Math.min(s, r[1]);
                                    e = Math.max(e, r[2]);
                                    i = Math.max(i, r[3]);
                        ...
                        #ae() {
                            return this.#Lt ? Math.ceil(this.thickness * this.parent.scaleFactor) : 0;
                        }
                        #Ht(t = !1) {
                            ...
                            const e = this.#he(),
                                s = this.#ae();
                            this.#Mt = Math.max(o, e[2] - e[0]);
                            this.#Ft = Math.max(o, e[3] - e[1]);
                            const n = Math.ceil(s + this.#Mt * this.scaleFactor),
                                i = Math.ceil(s + this.#Ft * this.scaleFactor),
                        ...
                        #ie() {
                            ...
                            if (this.#kt >= 1) {
                                t.minHeight = '16px';
                                t.minWidth = `${Math.round(this.#kt * o)}px`;
                            } else {
                                t.minWidth = '16px';
                                t.minHeight = `${Math.round(o / this.#kt)}px`;
                            }
                        }
                        static deserialize(t, e) {
                            const s = super.deserialize(t, e);
                            s.thickness = t.thickness;
                            s.color = n.Util.makeHexColor(...t.color);
                            s.opacity = t.opacity;
                            const [i, r] = e.pageDimensions,
                                a = s.width * i,
                                l = s.height * r,
                                c = e.scaleFactor,
                                h = t.thickness / 2;
                            ...
                            const d = s.#he();
                            s.#Mt = Math.max(o, d[2] - d[0]);
                            s.#Ft = Math.max(o, d[3] - d[1]);
                            s.#re(a, l);
                            return s;
                        }
                        serialize() {
                ...
                (t) => {
                    function fitCubic(t, e, s, n, i) {
                        ...
                        a = (function chordLengthParameterize(t) {
                            var e,
                                ...
                                i = [];
                            t.forEach((t, r) => {
                                e = r ? s + maths.vectorLen(maths.subtract(t, n)) : 0;
                                i.push(e);
                                s = e;
                                n = t;
                            });
                            return (i = i.map((t) => t / s));
                        })(t);
                        [r, l, h] = generateAndReport(t, a, a, e, s, i);
                        if (0 === l || l < n) return [r];
                        if (l < n * n) {
                            o = a;
                            c = l;
                            ...
                            for (b = 0; b < 20; b++) {
                                ...
                                [r, l, h] = generateAndReport(t, a, o, e, s, i);
                                if (l < n) return [r];
                                if (h === d) {
                                    let t = l / c;
                        ...
                        f = [];
                        if ((u = maths.subtract(t[h - 1], t[h + 1])).every((t) => 0 === t)) {
                            u = maths.subtract(t[h - 1], t[h]);
                            [u[0], u[1]] = [-u[1], u[0]];
                        }
                        p = maths.normalize(u);
                        g = maths.mulItems(p, -1);
                        return (f = (f = f.concat(fitCubic(t.slice(0, h + 1), e, p, n, i))).concat(
                            fitCubic(t.slice(h), g, s, n, i)
                        ));
                    }
                    function generateAndReport(t, e, s, n, i, r) {
                        var a, o, l;
                        a = (function generateBezier(t, e, s, n) {
                            var i,
                                r,
                                a,
                                o,
                            ...
                            for (m = 0, b = e.length; m < b; m++) {
                                y = 1 - (_ = e[m]);
                                (a = r[m])[0] = maths.mulItems(s, 3 * _ * (y * y));
                                a[1] = maths.mulItems(n, 3 * y * (_ * _));
                            }
                            o = [
                                [0, 0],
                                [0, 0],
                            ...
                            u = 0 === c ? 0 : d / c;
                            p = 0 === c ? 0 : h / c;
                            f = maths.vectorLen(maths.subtract(v, S));
                            if (u < (g = 1e-6 * f) || p < g) {
                                i[1] = maths.addArrays(v, maths.mulItems(s, f / 3));
                                i[2] = maths.addArrays(S, maths.mulItems(n, f / 3));
                            } else {
                        ...
                        [o, l] = (function computeMaxError(t, e, s) {
                            ...
                            for (o = 0, l = t.length; o < l; o++) {
                                c = t[o];
                                h = find_t(e, s[o], d, 10);
                                if ((n = (a = maths.subtract(bezier.q(e, h), c))[0] * a[0] + a[1] * a[1]) > i) {
                                    i = n;
                                    r = o;
                                }
                            }
                    ...
                    function newtonRaphsonRootFind(t, e, s) {
                        var n = maths.subtract(bezier.q(t, s), e),
                            i = bezier.qprime(t, s),
                            r = maths.mulMatrix(n, i),
                            a = maths.sum(maths.squareItems(i)) + 2 * maths.mulMatrix(n, bezier.qprimeprime(t, s));
                        return 0 === a ? s : s - r / a;
                    }
                    var mapTtoRelativeDistances = function (t, e) {
                        for (var s, n = [0], i = t[0], r = 0, a = 1; a <= e; a++) {
                            s = bezier.q(t, a / e);
                            r += maths.vectorLen(maths.subtract(s, i));
                            n.push(r);
                            i = s;
                        }
                        return (n = n.map((t) => t / r));
                    };
                    function find_t(t, e, s, n) {
                        if (e < 0) return 0;
                        if (e > 1) return 1;
                        for (var i, r, a, o, l = 1; l <= n; l++)
                            if (e <= s[l]) {
                                a = (l - 1) / n;
                                r = l / n;
                                o = ((e - (i = s[l - 1])) / (s[l] - i)) * (r - a) + a;
                                break;
                            }
                        return o;
                    }
                    ...
                    class bezier {
                        static q(t, e) {
                            ...
                            return maths.addArrays(maths.addArrays(n, i), maths.addArrays(r, a));
                        }
                        static qprime(t, e) {
                            var s = 1 - e,
                            ...
                            return maths.addArrays(maths.addArrays(n, i), r);
                        }
                    ...
                    t.exports = function fitCurve(t, e, s) {
                        ...
                        t.forEach((e) => {
                            if (!Array.isArray(e) || e.some((t) => 'number' != typeof t) || e.length !== t[0].length)
                                throw Error(
                                    'Each point should be an array of numbers. Each point should have the same amount of numbers.'
                                );
                        });
                        if ((t = t.filter((e, s) => 0 === s || !e.every((e, n) => e === t[s - 1][n]))).length < 2)
                            return [];
                        const n = t.length,
                            i = createTangent(t[1], t[0]),
                            r = createTangent(t[n - 2], t[n - 1]);
                        return fitCubic(t, i, r, e, s);
                    };
                ...
                (t, e, s) => {
                    ...
                    class AnnotationElement {
                        constructor(
                            t,
                            { isRenderable: e = !1, ignoreBorder: s = !1, createQuadrilaterals: n = !1 } = {}
                        ) {
                            this.isRenderable = e;
                            this.data = t.data;
                            this.layer = t.layer;
                        ...
                        _createContainer(t = !1) {
                            ...
                            if (!t && e.borderStyle.width > 0) {
                                ...
                                i
                                    ? (r.style.borderColor = n.Util.makeHexColor(0 | i[0], 0 | i[1], 0 | i[2]))
                                    : (r.style.borderWidth = 0);
                            }
                            r.style.left = (100 * (g[0] - l)) / u + '%';
                            r.style.top = (100 * (g[1] - c)) / p + '%';
                            const { rotation: f } = e;
                            if (e.hasOwnCanvas || 0 === f) {
                                r.style.width = (100 * a) / u + '%';
                                r.style.height = (100 * o) / p + '%';
                            } else this.setRotation(f, r);
                            return r;
                        }
                        setRotation(t, e = this.container) {
                            const [s, n, i, r] = this.viewport.viewBox,
                                a = i - s,
                                o = r - n,
                        ...
                        get _commonActions() {
                            const setColor = (t, e, s) => {
                                const n = s.detail[t];
                                s.target.style[e] = a.ColorConverters[`${n[0]}_HTML`](n.slice(1));
                            };
                        ...
                        _getElementsByName(t, e = null) {
                            ...
                            if (this._fieldObjects) {
                                ...
                                if (i)
                                    for (const { page: t, id: r, exportValues: a } of i) {
                                        if (-1 === t) continue;
                                        if (r === e) continue;
                                        const i = 'string' == typeof a ? a : null,
                                            o = document.querySelector(`[data-element-id="${r}"]`);
                                        !o || c.has(o)
                                            ? s.push({ id: r, exportValue: i, domElement: o })
                                            : (0, n.warn)(`_getElementsByName - element not allowed: ${r}`);
                                    }
                                return s;
                            }
                            for (const n of document.getElementsByName(t)) {
                                const { id: t, exportValue: i } = n;
                                t !== e && c.has(n) && s.push({ id: t, exportValue: i, domElement: n });
                            }
                            return s;
                        }
                        static get platform() {
                    ...
                    class LinkAnnotationElement extends AnnotationElement {
                        ...
                        _bindResetFormAction(t, e) {
                            ...
                            if (this._fieldObjects)
                                t.onclick = () => {
                                    s && s();
                                    const { fields: t, refs: i, include: r } = e,
                                        a = [];
                                    ...
                                    for (const t of a) {
                                        ...
                                        s &&
                                            (c.has(s)
                                                ...
                                                : (0, n.warn)(`_bindResetFormAction - element not allowed: ${e}`));
                                    }
                                    this.enableScripting &&
                                        this.linkService.eventBus?.dispatch('dispatcheventinsandbox', {
                                            source: this,
                    ...
                    class WidgetAnnotationElement extends AnnotationElement {
                        ...
                        _setEventListeners(t, e, s) {
                            for (const [n, i] of e)
                                ('Action' === i || this.data.actions?.[i]) && this._setEventListener(t, n, i, s);
                        }
                        _setBackgroundColor(t) {
                            const e = this.data.backgroundColor || null;
                            t.style.backgroundColor =
                                null === e ? 'transparent' : n.Util.makeHexColor(e[0], e[1], e[2]);
                        }
                        _setTextStyle(t) {
                            ...
                            r.color = n.Util.makeHexColor(s[0], s[1], s[2]);
                    ...
                    class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                        ...
                        render() {
                            ...
                            if (this.renderForms) {
                                ...
                                r && i.length > r && (i = i.slice(0, r));
                                const a = { userValue: i, formattedValue: null, valueOnFocus: '' };
                                if (this.data.multiLine) {
                                ...
                                s.addEventListener('input', (n) => {
                                    ...
                                    this.setPropertyOnSiblings(s, 'value', n.target.value, 'value');
                                });
                                    ...
                                    this.data.actions?.Keystroke &&
                                        s.addEventListener('beforeinput', (t) => {
                                            const { data: s, target: n } = t,
                                                { value: i, selectionStart: r, selectionEnd: a } = n;
                                            let o = r,
                                                l = a;
                                            switch (t.inputType) {
                                                case 'deleteWordBackward': {
                                                    const t = i.substring(0, r).match(/\w*[^\w]*$/);
                                                    t && (o -= t[0].length);
                                                    break;
                                                }
                                                case 'deleteWordForward': {
                                                    const t = i.substring(r).match(/^[^\w]*\w*/);
                                                    t && (l += t[0].length);
                                                    break;
                                                }
                    ...
                    class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
                        ...
                        render() {
                            ...
                            i.addEventListener('change', (n) => {
                                const { name: i, checked: r } = n.target;
                                for (const n of this._getElementsByName(i, s)) {
                                    const s = r && n.exportValue === e.exportValue;
                    ...
                    class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
                        ...
                        render() {
                            ...
                            i.addEventListener('change', (e) => {
                                ...
                                for (const e of this._getElementsByName(n, s)) t.setValue(e.id, { value: !1 });
                        ...
                        render() {
                            ...
                            const getValue = (t, e) => {
                                    ...
                                    return t.target.multiple
                                        ? Array.prototype.filter.call(n, (t) => t.selected).map((t) => t[s])
                                        : -1 === n.selectedIndex
                                        ? null
                                        : n[n.selectedIndex][s];
                                },
                                ...
                                n.addEventListener('updatefromsandbox', (s) => {
                                    const i = {
                                        value(s) {
                                            ...
                                            for (const t of n.options) t.selected = a.has(t.value);
                                        ...
                                        remove(s) {
                                            ...
                                            n.remove(r);
                                            if (i.length > 0) {
                                                -1 === Array.prototype.findIndex.call(i, (t) => t.selected) &&
                                                    (i[0].selected = !0);
                                            }
                                            t.setValue(e, { value: getValue(s, !0), items: getItems(s) });
                                        },
                                        clear(s) {
                                        ...
                                        insert(s) {
                                            const { index: i, displayValue: r, exportValue: a } = s.detail.insert,
                                                o = n.children[i],
                                        ...
                                        indices(s) {
                                            ...
                                            for (const t of s.target.options) t.selected = n.has(t.index);
                                            t.setValue(e, { value: getValue(s, !0) });
                                        },
                                        editable(t) {
                        ...
                        render() {
                            ...
                            if (s) {
                                const t = 0.7 * (255 - s[0]) + s[0],
                                    i = 0.7 * (255 - s[1]) + s[1],
                                    r = 0.7 * (255 - s[2]) + s[2];
                                e.style.backgroundColor = n.Util.makeHexColor(0 | t, 0 | i, 0 | r);
                            }
                            ...
                            if (
                                ...
                                o.XfaLayer.render({ xfaHtml: this.richText.html, intent: 'richText', div: e });
                    ...
                    class SquareAnnotationElement extends AnnotationElement {
                        ...
                        render() {
                            ...
                            r.setAttribute('x', i / 2);
                            r.setAttribute('y', i / 2);
                            r.setAttribute('width', e - i);
                            r.setAttribute('height', s - i);
                            r.setAttribute('stroke-width', i || 1);
                    ...
                    class CircleAnnotationElement extends AnnotationElement {
                        ...
                        render() {
                            ...
                            r.setAttribute('rx', e / 2 - i / 2);
                            r.setAttribute('ry', s / 2 - i / 2);
                            r.setAttribute('stroke-width', i || 1);
                            r.setAttribute('stroke', 'transparent');
                            r.setAttribute('fill', 'transparent');
                            n.append(r);
                    ...
                    class FileAttachmentAnnotationElement extends AnnotationElement {
                        constructor(t) {
                            ...
                            this.filename = (0, i.getFilenameFromUrl)(e);
                            this.content = s;
                    ...
                    class AnnotationLayer {
                        static #de(t, e, s, n) {
                            ...
                            r.id = `${i.AnnotationPrefix}${e}`;
                            s.append(t);
                            n?.moveElementInDOM(s, t, r, !1);
                        }
                        static render(t) {
                            const { annotations: e, div: s, viewport: a, accessibilityManager: o } = t;
                            this.#ue(s, a);
                            let l = 0;
                            for (const c of e) {
                                ...
                                if (e.isRenderable) {
                                    ...
                                    if (Array.isArray(t))
                                        for (const e of t) {
                                            e.style.zIndex = l++;
                                            AnnotationLayer.#de(e, c.id, s, o);
                                        }
                                    else {
                                        t.style.zIndex = l++;
                                        e instanceof PopupAnnotationElement
                                            ? s.prepend(t)
                                            : AnnotationLayer.#de(t, c.id, s, o);
                                    }
                                }
                            }
                            this.#pe(s, t.annotationCanvasMap);
                        }
                        static update(t) {
                        ...
                        static #ue(t, { width: e, height: s, rotation: n }) {
                            const { style: i } = t,
                                r = n % 180 != 0,
                                a = Math.floor(e) + 'px',
                                o = Math.floor(s) + 'px';
                            i.width = r ? o : a;
                            i.height = r ? a : o;
                            t.setAttribute('data-main-rotation', n);
                        }
                        static #pe(t, e) {
                            if (e) {
                                for (const [s, n] of e) {
                                    ...
                                    i ? ('CANVAS' === i.nodeName ? i.replaceWith(n) : i.before(n)) : e.append(n);
                                }
                                e.clear();
                            }
                        }
                ...
                (t, e) => {
                    ...
                    e.ColorConverters = class ColorConverters {
                        ...
                        static RGB_HTML([t, e, s]) {
                            return `#${makeColorComp(t)}${makeColorComp(e)}${makeColorComp(s)}`;
                        }
                        static T_HTML() {
                            return '#00000000';
                        }
                        ...
                        static RGB_CMYK([t, e, s]) {
                            const n = 1 - t,
                                i = 1 - e,
                                r = 1 - s;
                            return ['CMYK', n, i, r, Math.min(n, i, r)];
                        }
                    };
                },
                (t, e, s) => {
                    ...
                    e.XfaLayer = class XfaLayer {
                                ...
                                case 'input':
                                    if ('radio' === s.attributes.type || 'checkbox' === s.attributes.type) {
                                        r.value === s.attributes.xfaOn
                                            ...
                                            : r.value === s.attributes.xfaOff && t.removeAttribute('checked');
                                        if ('print' === i) break;
                                ...
                                case 'select':
                                    if (null !== r.value)
                                        for (const t of s.children)
                                            t.attributes.value === r.value && (t.attributes.selected = !0);
                                    t.addEventListener('input', (t) => {
                        ...
                        static setAttributes({ html: t, element: e, storage: s = null, intent: n, linkService: i }) {
                            const { attributes: r } = e,
                                a = t instanceof HTMLAnchorElement;
                            'radio' === r.type && (r.name = `${r.name}-${n}`);
                                ...
                                if (null != s)
                                    switch (e) {
                                        ...
                                        case 'textContent':
                                            ...
                                            break;
                                        default:
                                            (!a || ('href' !== e && 'newWindow' !== e)) && t.setAttribute(e, s);
                                    }
                            a && i.addLinkAttributes(t, r.href, r.newWindow);
                        ...
                        static render(t) {
                            ...
                            for (; o.length > 0; ) {
                                ...
                                a.append(d);
                                l.attributes &&
                                    this.setAttributes({ html: d, element: l, storage: e, intent: r, linkService: s });
                ...
                (t, e, s) => {
                    ...
                    function appendText(t, e, s, i) {
                        ...
                        t._textDivs.push(l);
                        const h = n.Util.transform(t._viewport.transform, e.transform);
                        ...
                        const p = Math.hypot(h[2], h[3]),
                            g =
                                ...
                                (function getAscent(t, e) {
                                    ...
                                    e.clearRect(0, 0, r, r);
                                    e.strokeText('g', 0, 0);
                                    let l = e.getImageData(0, 0, r, r).data;
                                    o = 0;
                        ...
                        let b = !1;
                        if (e.str.length > 1 || (t._enhanceTextSelection && o.test(e.str))) b = !0;
                        ...
                        b &&
                            (u.vertical
                                ? (c.canvasWidth = e.height * t._viewport.scale)
                                : (c.canvasWidth = e.width * t._viewport.scale));
                        ...
                        if (t._enhanceTextSelection && c.hasText) {
                            ...
                            const r = (u.vertical ? e.height : e.width) * t._viewport.scale,
                                a = p;
                            let o, c;
                            if (0 !== d) {
                                o = [s, i, -i, s, f, m];
                                c = n.Util.getAxialAlignedBoundingBox([0, 0, r, a], o);
                            } else c = [f, m, f + r, m + a];
                            t._bounds.push({
                                left: c[0],
                                top: c[1],
                    ...
                    function render(t) {
                        ...
                        if (n > 1e5) {
                            ...
                            if (!t._textContentStream) for (let s = 0; s < n; s++) t._layoutText(e[s]);
                            t._renderingDone = !0;
                            s.resolve();
                        }
                    }
                    ...
                    function expand(t) {
                        const e = t._bounds,
                            s = t._viewport,
                            i = (function expandBounds(t, e, s) {
                                const n = s.map(function (t, e) {
                                    return {
                                        x1: t.left,
                                        y1: t.top,
                                        x2: t.right,
                                ...
                                for (const t of n) {
                                    const e = t.index;
                                    i[e] = { left: t.x1New, top: 0, right: t.x2New, bottom: 0 };
                                }
                                s.map(function (e, s) {
                                    const r = i[s],
                                        a = n[s];
                        ...
                        for (let s = 0; s < i.length; s++) {
                            const r = e[s].div,
                                a = t._textDivProperties.get(r);
                            if (0 === a.angle) {
                                a.paddingLeft = e[s].left - i[s].left;
                                a.paddingTop = e[s].top - i[s].top;
                                a.paddingRight = i[s].right - e[s].right;
                                a.paddingBottom = i[s].bottom - e[s].bottom;
                                t._textDivProperties.set(r, a);
                                continue;
                            }
                            const o = i[s],
                                l = e[s],
                            ...
                            for (let t = 0, e = u.length; t < e; t++) {
                                const e = n.Util.applyTransform(u[t], c);
                                p[t + 0] = h && (o.left - e[0]) / h;
                                p[t + 4] = d && (o.top - e[1]) / d;
                                p[t + 8] = h && (o.right - e[0]) / h;
                                p[t + 12] = d && (o.bottom - e[1]) / d;
                                p[t + 16] = d && (o.left - e[0]) / -d;
                                p[t + 20] = h && (o.top - e[1]) / h;
                                p[t + 24] = d && (o.right - e[0]) / -d;
                                p[t + 28] = h && (o.bottom - e[1]) / h;
                                p[t + 32] = h && (o.left - e[0]) / -h;
                                p[t + 36] = d && (o.top - e[1]) / -d;
                                p[t + 40] = h && (o.right - e[0]) / -h;
                                p[t + 44] = d && (o.bottom - e[1]) / -d;
                                p[t + 48] = d && (o.left - e[0]) / d;
                                p[t + 52] = h && (o.top - e[1]) / -h;
                                p[t + 56] = d && (o.right - e[0]) / d;
                                p[t + 60] = h && (o.bottom - e[1]) / -h;
                            }
                            const g = 1 + Math.min(Math.abs(h), Math.abs(d));
                            a.paddingLeft = findPositiveMin(p, 32, 16) / g;
                            a.paddingTop = findPositiveMin(p, 48, 16) / g;
                            a.paddingRight = findPositiveMin(p, 0, 16) / g;
                            a.paddingBottom = findPositiveMin(p, 16, 16) / g;
                            t._textDivProperties.set(r, a);
                        }
                    }
                    function expandBoundsLTR(t, e) {
                        ...
                        for (const t of e) {
                            let e = 0;
                            for (; e < s.length && s[e].end <= t.y1; ) e++;
                            let n,
                                i,
                                r = s.length - 1;
                            for (; r >= 0 && s[r].start >= t.y2; ) r--;
                            let a,
                                o,
                                l = -1 / 0;
                            for (a = e; a <= r; a++) {
                            ...
                            for (a = e; a <= r; a++) {
                                n = s[a];
                                i = n.boundary;
                                const e = i.x2 > t.x2 ? i : t;
                                if (h === e) c.at(-1).end = n.end;
                                else {
                                    c.push({ start: n.start, end: n.end, boundary: e });
                                    h = e;
                                }
                            }
                            if (s[e].start < t.y1) {
                                c[0].start = t.y1;
                                c.unshift({ start: s[e].start, end: t.y1, boundary: s[e].boundary });
                            }
                            if (t.y2 < s[r].end) {
                                c.at(-1).end = t.y2;
                                c.push({ start: t.y2, end: s[r].end, boundary: s[r].boundary });
                            }
                            for (a = e; a <= r; a++) {
                                n = s[a];
                                i = n.boundary;
                                if (void 0 !== i.x2New) continue;
                                let t = !1;
                                for (o = e - 1; !t && o >= 0 && s[o].start >= i.y1; o--) t = s[o].boundary === i;
                                for (o = r + 1; !t && o < s.length && s[o].end <= i.y2; o++) t = s[o].boundary === i;
                                for (o = 0; !t && o < c.length; o++) t = c[o].boundary === i;
                                t || (i.x2New = l);
                            }
                            Array.prototype.splice.apply(s, [e, r - e + 1, ...c]);
                        }
                        for (const e of s) {
                            const s = e.boundary;
                            void 0 === s.x2New && (s.x2New = Math.max(t, s.x2));
                        }
                    }
                    class TextLayerRenderTask {
                        ...
                        _processItems(t, e) {
                            for (let s = 0, n = t.length; s < n; s++)
                                if (void 0 !== t[s].str) {
                                    this._textContentItemsStr.push(t[s].str);
                                    appendText(this, t[s], e, this._layoutTextCtx);
                                } else if (
                                    'beginMarkedContentProps' === t[s].type ||
                                    'beginMarkedContent' === t[s].type
                                ) {
                                    const e = this._container;
                                    this._container = document.createElement('span');
                                    this._container.classList.add('markedContent');
                                    null !== t[s].id && this._container.setAttribute('id', `${t[s].id}`);
                                    e.append(this._container);
                                } else
                                    'endMarkedContent' === t[s].type && (this._container = this._container.parentNode);
                        }
                        _layoutText(t) {
                            const e = this._textDivProperties.get(t);
                            let s = '';
                            if (0 !== e.canvasWidth && e.hasText) {
                                const { fontFamily: n } = t.style,
                                    { fontSize: i } = e;
                                if (i !== this._layoutTextLastFontSize || n !== this._layoutTextLastFontFamily) {
                                    this._layoutTextCtx.font = `${i * this._devicePixelRatio}px ${n}`;
                                    this._layoutTextLastFontSize = i;
                                    this._layoutTextLastFontFamily = n;
                                }
                                const { width: r } = this._layoutTextCtx.measureText(t.textContent);
                                if (r > 0) {
                                    const t = (this._devicePixelRatio * e.canvasWidth) / r;
                        ...
                        _render(t = 0) {
                            ...
                            if (this._textContent) {
                                ...
                                {
                                    const pump = () => {
                                        this._reader.read().then(({ value: t, done: n }) => {
                                            if (n) e.resolve();
                                            else {
                            ...
                            for (let n = 0, i = this._textDivs.length; n < i; n++) {
                                ...
                                if (r.hasText)
                                    if (t) {
                                        e.length = 0;
                                        s.length = 0;
                                        r.originalTransform && e.push(r.originalTransform);
                                        if (r.paddingTop > 0) {
                                            s.push(`${r.paddingTop}px`);
                                            e.push(`translateY(${-r.paddingTop}px)`);
                                        } else s.push(0);
                                        r.paddingRight > 0 ? s.push(r.paddingRight / r.scale + 'px') : s.push(0);
                                        r.paddingBottom > 0 ? s.push(`${r.paddingBottom}px`) : s.push(0);
                                        if (r.paddingLeft > 0) {
                                            s.push(r.paddingLeft / r.scale + 'px');
                                            e.push(`translateX(${-r.paddingLeft / r.scale}px)`);
                                        } else s.push(0);
                                        i.style.padding = s.join(' ');
                                        e.length && (i.style.transform = e.join(' '));
                                    } else {
                                        i.style.padding = null;
                                        i.style.transform = r.originalTransform;
                                    }
                            }
                        }
                    }
                ...
                (t, e, s) => {
                    ...
                    e.SVGGraphics = a;
                    {
                        const o = { fontStyle: 'normal', fontWeight: 'normal', fillColor: '#000000' },
                            ...
                            u = (function () {
                                ...
                                function writePngChunk(t, s, n, i) {
                                    ...
                                    n[r + 3] = 255 & a;
                                    r += 4;
                                    n[r] = 255 & t.charCodeAt(0);
                                    n[r + 1] = 255 & t.charCodeAt(1);
                                    n[r + 2] = 255 & t.charCodeAt(2);
                                    n[r + 3] = 255 & t.charCodeAt(3);
                                    r += 4;
                                    n.set(s, r);
                                    r += s.length;
                                ...
                                function encode(e, s, n, a) {
                                    ...
                                    if (s === i.ImageKind.GRAYSCALE_1BPP && a) {
                                        g = 0;
                                        for (let t = 0; t < l; t++) {
                                            g++;
                                    ...
                                    const m = new Uint8Array([
                                        ...
                                        b = (function deflateSync(t) {
                                            ...
                                            try {
                                                ...
                                                (0, i.warn)(
                                                    'Not compressing PNG because zlib.deflateSync is unavailable: ' + t
                                                );
                                            }
                        ...
                        function opListToTree(t) {
                            ...
                            const s = [];
                            for (const n of t)
                                if ('save' !== n.fn) 'restore' === n.fn ? (e = s.pop()) : e.push(n);
                                else {
                        ...
                        e.SVGGraphics = a = class {
                            ...
                            setTextMatrix(t, e, s, n, i, r) {
                                ...
                                a.textMatrix = a.lineMatrix = [t, e, s, n, i, r];
                            ...
                            showText(t) {
                                ...
                                const b = e.textRenderingMode & i.TextRenderingMode.FILL_STROKE_MASK;
                                ...
                                e.txtElement.setAttributeNS(null, 'transform', `${pm(A)} scale(${pf(d)}, -1)`);
                            ...
                            shadingFill(t) {
                                const e = this.viewport.width,
                                    ...
                                    r = i.Util.applyTransform([0, 0], n),
                                    a = i.Util.applyTransform([0, s], n),
                            ...
                            _makeTilingPattern(t) {
                                const e = t[1],
                                    ...
                                    d = t[7],
                                    u = 'shading' + f++,
                                    [p, g, m, b] = i.Util.normalizeRect([
                                        ...i.Util.applyTransform([r, a], n),
                                ...
                                const x = this.svg,
                                    ...
                                    T = this.svgFactory.create(m - p, b - g);
                                this.svg = T;
                                    ...
                                    case 'RadialAxial':
                                        ...
                                        switch (t[1]) {
                                            ...
                                            case 'radial':
                                                ...
                                                n.setAttributeNS(null, 'fx', r[0]);
                                                n.setAttributeNS(null, 'fy', r[1]);
                            ...
                            constructPath(t, e) {
                                ...
                                for (const s of t)
                                    switch (0 | s) {
                                        ...
                                        case i.OPS.curveTo3:
                                            n = e[o + 2];
                                            r = e[o + 3];
                                            a.push('C', pf(e[o]), pf(e[o + 1]), pf(n), pf(r), pf(n), pf(r));
                                            o += 4;
                                            break;
                                        case i.OPS.closePath:
                                            a.push('Z');
                                ...
                                a = a.join(' ');
                                if (s.path && t.length > 0 && t[0] !== i.OPS.rectangle && t[0] !== i.OPS.moveTo)
                            ...
                            paintImageXObject(t) {
                                ...
                                e
                                    ...
                                    : (0, i.warn)(`Dependent image with object ID ${t} is not ready yet`);
                            }
                            paintInlineImageXObject(t, e) {
                                ...
                                a.setAttributeNS(null, 'y', pf(-n));
                                a.setAttributeNS(null, 'width', pf(s) + 'px');
                                a.setAttributeNS(null, 'height', pf(n) + 'px');
                                a.setAttributeNS(null, 'transform', `scale(${pf(1 / s)} ${pf(-1 / n)})`);
                            ...
                            paintImageMaskXObject(t) {
                                ...
                                r.setAttributeNS(null, 'id', e.maskId);
                                ...
                                a.setAttributeNS(null, 'mask', `url(#${e.maskId})`);
                                this.defs.append(r);
                ...
                (t, e, s) => {
                    ...
                    class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                        constructor(t, e, s) {
                            ...
                            this._setReadableStream(r.createReadStream(n, { start: e, end: s - 1 }));
                        }
                    }
                },
                (t, e, s) => {
                    ...
                    e.validateRangeRequestCapabilities = function validateRangeRequestCapabilities({
                        ...
                        if (!Number.isInteger(r)) return i;
                        i.suggestedLength = r;
                        if (r <= 2 * s) return i;
                        if (n || !e) return i;
                    ...
                    e.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(t) {
                        ...
                        function rfc2047decode(t) {
                            return !t.startsWith('=?') || /[\x00-\x19\x80-\xff]/.test(t)
                                ? t
                                : t.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, function (t, e, s, n) {
                                      if ('q' === s || 'Q' === s)
                                          return textdecode(
                                              e,
                ...
                (t, e, s) => {
                    ...
                    class NetworkManager {
                        ...
                        onStateChange(t, e) {
                            ...
                            const r = i.status || 200;
                            if (!(200 === r && 206 === s.expectedStatus) && r !== s.expectedStatus) {
                                s.onError?.(i.status);
                                return;
                            }
                            ...
                            } else a ? s.onDone({ begin: 0, chunk: a }) : s.onError?.(i.status);
                        }
                        getRequestXhr(t) {
                    ...
                    e.PDFNetworkStream = class PDFNetworkStream {
                        ...
                        getRangeReader(t, e) {
                            const s = new PDFNetworkStreamRangeRequestReader(this._manager, t, e);
                    ...
                    class PDFNetworkStreamFullRequestReader {
                        ...
                        _onHeadersReceived() {
                            const t = this._fullRequestId,
                                ...
                                { allowRangeRequests: s, suggestedLength: n } = (0, i.validateRangeRequestCapabilities)(
                                    {
                                        getResponseHeader: getResponseHeader,
                    ...
                    class PDFFetchStreamRangeReader {
                        constructor(t, e, s) {
                            ...
                            fetch(a, createFetchOptions(this._headers, this._withCredentials, this._abortController))
                                .then((t) => {
                                    if (!(0, i.validateResponseStatus)(t.status))
                                        throw (0, i.createResponseStatusError)(t.status, a);
                                    this._readCapability.resolve();
                                    this._reader = t.body.getReader();
                                })
        ...
        (() => {
            ...
            if (l.isNodeJS) {
                const { PDFNodeStream: t } = __w_pdfjs_require__(32);
                (0, s.setPDFNetworkStreamFactory)((e) => new t(e));
            } else {
                const { PDFNetworkStream: t } = __w_pdfjs_require__(35),
                    { PDFFetchStream: e } = __w_pdfjs_require__(36);
                (0, s.setPDFNetworkStreamFactory)((s) => ((0, n.isValidFetchUrl)(s.url) ? new e(s) : new t(s)));
            }
        })();
